      ...
      <div className="mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        ...
        <div className="hidden md:flex flex-1 justify-center">
          <div className="flex space-x-8">
            ...
            <NavLink href="/prize" label="Prize" />
            <NavLink href="/timeline" label="Timeline" />
            <NavLink href="/sponsors" label="Our Sponsors" />
        ...
        <div className="md:hidden flex items-center">
          <button
            onClick={toggleMenu}
            className="bg-black p-2 rounded-md text-gray-400 hover:text-white hover:bg-gray-700 focus:outline-none"
          >
            <span className="sr-only">Open main menu</span>
            {!isOpen ? (
...
const NavLink = ({ href, label }) => (
  <Link href={href} className="text-white hover:text-red-500 px-3 py-2 text-sm font-bold transition-colors">
    {label}
  </Link>
);
