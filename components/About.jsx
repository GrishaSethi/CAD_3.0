...
const handleScrollToPrizes = () => {
  setTimeout(() => {
    const prizePool = document.getElementById('prize-pool'); // Correct id
    if (prizePool) {
      prizePool.scrollIntoView({ behavior: 'smooth' });
    } else {
      console.error('Element #prize-pool not found in the DOM.');
    }
  }, 100);
};
